...
useSeoMeta({
    title: 'GTATunes',
    description: 'Listen to all of the radio stations from the GTA 3D universe in one place!',
    ogImage: '/logo.png'
});
...
<template>
    <section class="hero">
        <img class="hero__bg" src="@/assets/images/game-bgs/sa-hero.jpg">
        <div class="container">
            <img src="@/assets/images/logos/gtatunes.png" alt="Grand Theft Auto Tunes">
    ...
    <div class="games-container">
        <div class="games">
            <RouterLink class="game" v-for="game of games" :to="`/${game.key}`" :class="{'game--unfinished': !game.finished}">
